...
infoWindowContent() ->
	wf:to_list(wf:render(#blockquote{body= <<"(*ﾟ∇ﾟ)今日之我已不是昨日之我！(*ﾟ∇ﾟ)"/utf8>>,style=["font-weight: bold; margin-bottom: 0px;"]})) ++ wf:to_list(wf:render(#panel{id=wf:state(infowindow)})).
